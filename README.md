...
<br>
<p align="justify"> I am Çisem Yaşar. I work as a lecturer in the Department of Computer Technologies at Istanbul Gelisim University, and I am also the Head of the Software, Application Development and Analysis Department and the Head of the Pre-Face Software Development Program.
My academic and professional focus covers the fields of computer networks, open source operating systems, cyber security, internet programming, advanced internet programming, security in web applications, and system analysis and design. While providing education to undergraduate and associate degree students in these fields, I also address sectoral innovations and current technologies in my academic studies and aim to bring my students together with this vision.
My goal is to train qualified software developers and IT specialists who not only use technology, but also produce and develop it, and design secure and sustainable solutions.</h3>
